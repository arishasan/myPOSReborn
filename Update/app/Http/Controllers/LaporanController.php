...
class LaporanController extends Controller
{
    ...
    public function transaksi_index(){
        ...
        return view('admin.pages.laporan.transaksi_index')->with($data);

    }

    public function transaksi_get(Request $req){
        ...
        if($req->ajax()){
            ...
            return Datatables::of($data)
                ...
                ->editColumn('jumlah_harga', function($row){
                    ...
                    return '<div style="text-align: right"><b>Rp. <label class="jml_terjual">'.number_format(($row->jumlah_harga - $row->diskon_nominal)).'</label></b></div>';
