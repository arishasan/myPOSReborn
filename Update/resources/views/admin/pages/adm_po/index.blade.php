...
<div id="content" class="app-content">
  ...
  <ol class="breadcrumb float-xl-end">
    <li class="breadcrumb-item">{{ Request::is('laporan/po') ? 'Laporan' : 'Transaksi' }}</li>
    <li class="breadcrumb-item"><a href="javascript:;">Data</a></li>
    <li class="breadcrumb-item active">Pemesanan Barang</li>
  </ol>
  <!-- END breadcrumb -->
  <!-- BEGIN page-header -->
  <h1 class="page-header">{{ Request::is('laporan/po') ? 'Laporan' : 'Data' }} Pemesanan Barang </h1>
  <!-- END page-header -->
  ...
  <div class="row">
    <div class="col-xl-12">
      ...
      <ul class="nav nav-tabs" id="myTab">
        ...
        <li class="nav-item" {{ Request::is('laporan/po') ? 'hidden' : '' }}>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-white">
          <h5><i class="fa fa-info-circle"></i> Perhatian</h5>
          <p id="alert_content">Anda yakin akan menyelesaikan Pemesanan Barang ini ?</p>
          <center>
      ...
      $('#data_table').DataTable({
        ...
        ajax: {
            ...
            'data': {
               ...
               from: date_from,
               to: date_to,
               type: "{{ Request::is('laporan/po') ? 'laporan' : 'data' }}"
            },
        },
        columns: [
            {data: 'id', name: 'id'},
