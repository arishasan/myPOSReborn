...
<div id="content" class="app-content">
  ...
  <!-- END breadcrumb -->
  <!-- BEGIN page-header -->
  <h1 class="page-header">Data Transaksi Pembelian</h1>
  <!-- END page-header -->
  ...
  <div class="row">
    <div class="col-xl-12">
      ...
      <ul class="nav nav-tabs" id="myTab">
        ...
        <li class="nav-item">
          <a href="#default-tab-3" data-bs-toggle="tab" class="nav-link" id="tab_tiga">Transaksi Baru</a>
        </li>
                    ...
                    <div class="row">
                      <div class="col-lg-3">
                        ...
                        <div class="form-group row mb-3">
                          <label class="col-lg-12 col-form-label form-label">Periode Dari</label>
                          <div class="col-lg-12">
                            <input type="date" class="form-control" id="periode_dari" value="{{ date('Y-m-d', strtotime('first day of this month')) }}">
                          </div>
                        </div>
                      ...
                      <div class="col-lg-3">
                        ...
                        <div class="form-group row mb-3">
                          <label class="col-lg-12 col-form-label form-label">Periode Sampai</label>
                          <div class="col-lg-12">
                            <input type="date" class="form-control" id="periode_ke" value="{{ date('Y-m-d', strtotime('last day of this month')) }}">
                          </div>
                        </div>
                      ...
                      <div class="col-lg-3">
                        <div class="form-group row mb-3">
                          ...
                          <div class="col-lg-12">
                            <button type="button" class="btn btn-outline-primary form-control" id="cariTrx"><i class="fa fa-search"></i> Cari</button>
                          </div>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="data_table_main" style="width: 100%" class="table table-bordered table-striped align-middle h4">
                        <thead>
                          <tr>
                            <th width="1%"></th>
        ...
        <div class="tab-pane fade" id="default-tab-3">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <form method="POST" id="form_tambah" action="{{ route('simpan-transaksi') }}" data-parsley-validate="true" name="demo-form" enctype="multipart/form-data">  
                @csrf
                  ...
                  <div class="card">
                    <div class="card-header">
                      <div class="row vertical-align">
                        <div class="col-lg-7">
                          <i class="fa fa-cart-plus"></i> Keranjang Belanja
                        </div>
                        <div class="col-lg-5">
                          <button type="button" class="btn btn-outline-danger form-control btn-sm" id="kosongkan_cart"><small>Kosongkan Keranjang</small></button>
                        </div>
                      </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card-body">
                          <div class="row vertical-align mb-2">
                            ...
                            <div class="col-lg-8 align-self-end" style="text-align: right;">
                              ...
                              <input type="datetime-local" class="form-control" name="tgl_trx" value="{{ date('Y-m-d H:i:s') }}">
                            </div>  
                          </div>
                          <div class="row vertical-align mb-2">
                            <div class="col-lg-4 vcenter"><label>Nama Pembeli</label></div>
                            <div class="col-lg-8 align-self-end" style="text-align: right;">
                              <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli" placeholder="Required" value="<?= (Auth()->user()->role == 'Pembeli' ? Auth()->user()->name : '') ?>" required <?= (Auth()->user()->role == 'Pembeli' ? 'readonly' : '') ?>>
                            </div>  
                          </div>
                          <div class="row vertical-align mb-2">
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="row vertical-align mb-2" <?= (Auth()->user()->role == 'Pembeli' ? 'hidden' : '') ?>>
                            ...
                            <div class="col-lg-8 align-self-end" style="text-align: right;">
                              <input type="text" class="form-control currency" name="cart_diskon" id="cart_diskon" value="0" style="text-align: right;">
                            </div>  
                          </div>
                          ...
                          <div class="row vertical-align mb-2" <?= (Auth()->user()->role == 'Pembeli' ? 'hidden' : '') ?>>
                            ...
                            <div class="col-lg-8 align-self-end" style="text-align: right;">
                              <input type="text" class="form-control currency" name="cart_dibayarkan" id="cart_dibayarkan" value="0" style="text-align: right;">
                            </div>  
                          </div>
                      ...
                      <div style="text-align: right;">
                        ...
                        <button type="button" class="btn btn-outline-primary" id="btn_tambah_data"><i class="fa fa-save"></i> <?= (Auth()->user()->role == 'Pembeli' ? 'Pesan' : 'Simpan') ?></button>
                      </div>
...
<script type="text/javascript">
    ...
    function callKeranjang(){
      ...
      let link = '{{ route("get-data-keranjang") }}';
      ...
      $.get(link, function(res){
        ...
        $.each(parse, function(idx, val){
          ...
          let harga = (val.qty_input >= val.qty_min_grosir ? val.harga_grosir : val.harga_eceran);
          ...
          '<button type="button" class="btn btn-outline-danger btn-sm delete_item_cart" data-id="'+val.id_keranjang+'"><i class="fa fa-trash"></i></button>' + 
    ...
    $(function(){
      ...
      $('#body_trx').on('click','.detil_transaksi', function(){

        let data = $(this).attr('data-id');
        let kode = $(this).attr('data-kode');
        let link = "{{ url('transaksi/get_detail') }}/" + data;
      ...
      $('#body_trx').on('click', '.delete_button', function(){
      ...
      $('#btn_submit').click(function(){
        ...
        let link = '{{ url("transaksi/delete/") }}/'+id;
        $.get(link, function(res){
          location.reload();
        });
      ...
      $('#holder_detail').on('click', '.voidcancel_trx', function(){

        let id = $(this).attr('data-id');
        let type = $(this).attr('data-type');

        let link = '{{ url("transaksi/void_cancel_trx") }}/'+type+'/'+id;

        swal({
            title: type.toUpperCase() + " TRANSAKSI",
          ...
          .then((willDo) => {
            if (willDo) {
              ...
              $.get(link, function(res){
                ...
                if(res == 'yes'){
                  swal("Yay!", "Berhasil " + type.toUpperCase() + " transaksi.", "success");
                }else{
                  swal("Oops!", "Gagal " + type.toUpperCase() + " transaksi.", "error");
                }

                $('#modal_detail').modal('hide');
                $('#cariTrx').trigger('click');
      ...
      $('#kosongkan_cart').click(function(){
        ...
        swal({
          title: "Perhatian",
          text: "Kosongkan keranjang belanja?",
          icon: "info",
          buttons: true,
        })
        .then((willEmpty) => {
          if (willEmpty) {
            ...
            $.get(link, function(res){
              ...
              if(res == 'yes'){
                swal("Yay!", "Berhasil mengosongkan keranjang belanja.", "success");
                callKeranjang();
              }else{
                swal("Oops!", "Keranjang belanja anda kosong.", "error");
              }
      ...
      $(document).on('click', '.delete_item_cart', function(){
        ...
        let id = $(this).attr('data-id');
        let link = '{{ url("transaksi/barang/keranjang/delete") }}/'+id;
        $('body').addClass("loading");
        ...
        $.get(link, function(res){
          ...
          $('body').removeClass("loading");
          if(res == 'yes'){
            swal("Yay!", "Berhasil menghapus item dari keranjang.", "success");
            callKeranjang();
          }else{
            swal("Oops!", "Gagal menghapus item dari keranjang. Silahkan ulangi lagi.", "error");
          }
            ...
            $('body').addClass("loading");
             ...
             $.ajax({
                  ...
                  error: function(jqXHR, textStatus, errorThrown) {
                     $('body').removeClass("loading");
                     swal("Oops!", "Gagal menambahkan barang ke keranjang belanja. Silahkan ulangi.", "error");
                  }
              });
