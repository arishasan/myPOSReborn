...
<div id="content" class="app-content">
  ...
  <ol class="breadcrumb float-xl-end">
    <li class="breadcrumb-item"><a href="javascript:;">{{ Request::is('laporan/stok_opname') ? 'Laporan' : 'Transaksi' }}</a></li>
    <li class="breadcrumb-item active">Stok Opname</li>
  </ol>
  <!-- END breadcrumb -->
  <!-- BEGIN page-header -->
  <h1 class="page-header">{{ Request::is('laporan/stok_opname') ? 'Laporan' : 'Data' }} Stok Opname </h1>
  <!-- END page-header -->
  ...
  <div class="row">
    <div class="col-xl-12">
      ...
      <ul class="nav nav-tabs" id="myTab">
        ...
        <li class="nav-item" {{ Request::is('laporan/stok_opname') ? 'hidden' : '' }}>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-lg-12">
                      <input type="date" class="form-control" id="periode_dari" value="{{ date('Y-m-01') }}">
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-lg-12">
                      <input type="date" class="form-control" id="periode_ke" value="{{ date('Y-m-t') }}">
                    </div>
                  </div>
                </div>
                <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    function callTable(){
      ...
      $('#data_table').DataTable({
        ...
        ajax: {
            'type': 'POST',
            'url': "{{ route('get-data-stock-opname') }}",
            'data': {
               periode_dari: periode_dari,
               periode_ke: periode_ke,
               type: "{{ Request::is('laporan/stok_opname') ? 'laporan' : 'data' }}"
            },
        },
        columns: [
            {data: 'id', name: 'id'},
            {data: 'tgl_opname', name: 'tgl_opname'},
            {data: 'oleh', name: 'users.name'},
